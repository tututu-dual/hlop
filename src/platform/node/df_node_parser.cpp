...
const std::vector<std::string> hlop::df_node_parser::parse_node_list_aux(const std::string &node_list_str) {
...
const std::vector<hlop::node> hlop::df_node_parser::parse_node_list(const std::string &node_list_str) {
	std::vector<hlop::node> nodes;
